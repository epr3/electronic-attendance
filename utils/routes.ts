...
const withYearAndClassId =
  ...
  ({
    ...
    `/${schoolId}/years/${yearId}/classes/${classId}${url}`;
...
export const routes = {
  ...
  school: {
    get: (schoolId: string) => `/${schoolId}`,
  },
  admin: {
    index: withSchoolId("/admin"),
    students: {
      index: withSchoolId("/admin/students"),
      new: withSchoolId("/admin/students/new"),
      get: (studentId: string) => withSchoolId(`/admin/students/${studentId}`),
    },
    teachers: {
      index: withSchoolId("/admin/teachers"),
      new: withSchoolId("/admin/teachers/new"),
      get: (teacherId: string) => withSchoolId(`/admin/teachers/${teacherId}`),
    },
  },
  users: {
